...
class SoftwareEngineer:
    def __init__(self):
        ...
        self.education = "B.Tech CSE (Cyber Security), SRM IST"
        self.location = "Chennai, Tamil Nadu, India"
        self.currently_learning = ["AI/ML systems", "Secure full-stack architecture"]

    def say_hi(self):
        print("Thanks for stopping by — always open to building something new.")
